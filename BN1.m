...
P_Xb_given_Pd_prime = EM(Xb_train, Pd_train, [theta_0(domain); theta_0(domain)]);
P_Xh_given_Pd_prime = EM(Xh_train, Pd_train, [theta_0(domain); theta_0(domain)]);
P_Xt_given_Pd_prime = EM(Xt_train, Pd_train, [theta_0(domain); theta_0(domain)]);
