...
P_Xb_prime_given_Pd_prime = BN1.EM(Xb_prime_train, Pd_prime_train, initialize_cpt());
P_Xh_prime_given_Pd_prime = BN1.EM(Xh_prime_train, Pd_prime_train, initialize_cpt());
P_Xt_prime_given_Pd_prime = BN1.EM(Xt_prime_train, Pd_prime_train, initialize_cpt());
