...
Xa_prime_train = [Xa_train(2:end); nan];
...
Pd_prime_test = [Pd_test(2:end); nan];
Xb_prime_test = [Xb_test(2:end); nan];
Xh_prime_test = [Xh_test(2:end); nan];
Xt_prime_test = [Xt_test(2:end); nan];
